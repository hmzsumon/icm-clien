				...
				<div className='program-banner p-10 bg-no-repeat bg-top bg-cover text-white '>
					<div className='w-full md:w-2/3'>
						...
						<p className='w-full text-sm font-semibold leading-normal tracking-wide mt-5'>
							Our global partners bring diverse expertise and networks.
							Together, we navigate investment landscapes—from Wall Street to
							emerging markets. Their insights fuel our strategies.
						</p>
